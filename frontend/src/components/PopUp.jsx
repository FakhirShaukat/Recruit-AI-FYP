...
const PopUp = ({ showPopup }) => {
  ...
  return (
    <div className="fixed top-14 right-10 z-50 ">
      <div className="text-lg rounded-md flex bg-white shadow-md text-black p-4 w-[15rem] h-[280px] flex-col border-gray-200 border">
        ...
        <div className="signoutBtn border max-w-[40%] bg-red-600 hover:bg-red-700 transition duration-300 text-white mt-auto rounded-md">
